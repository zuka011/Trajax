...
class DefaultIdAssignment(ObstacleIdAssignment[Any, Any]):
    def __call__(self, states: Any, /) -> None:
        return None


@dataclass(kw_only=True)
class PredictingObstacleStateProvider[
    ObstacleStatesForTimeStepT: ObstacleStatesForTimeStep,
    IdT,
    HistoryT,
    PredictionT,
    ...
    id_assignment: ObstacleIdAssignment[ObstacleStatesForTimeStepT, IdT]
    ...
    def create[O: ObstacleStatesForTimeStep, I, H, P](
        *,
        ...
        id_assignment: ObstacleIdAssignment[O, I] | None = None,
    ...
    def observe(self, states: ObstacleStatesForTimeStepT) -> None:
        self.history = self.history.append(states, ids=self.id_assignment(states))
